...
This project presents an interactive Excel dashboard designed to analyze Hospital Emergency Room operations and patient trends.

The dashboard provides insights into patient volume, waiting time, admission patterns, patient satisfaction, demographics and department referrals.
...
- Admission Rate: ~50%
- Average Patient Satisfaction: ~5/10
